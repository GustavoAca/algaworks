...
import com.algaworks.algalog.domain.service.RegistroOcorreniaService;
...
public class OcorrenciaController {
	...
	private RegistroOcorreniaService registroOcorreniaService;
	...
	public OcorrenciaModel registrar(@PathVariable Long entregaId,
		...
		Ocorrencia ocorrenciaRegistrata = registroOcorreniaService
				.registar(entregaId, ocorrenciaInput.getDescricao());

		return ocorrenciaAssembler.toModel(ocorrenciaRegistrata);
	}
